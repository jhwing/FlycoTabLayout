...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTabPaddingTop = ta.getDimension(R.styleable.SlidingTabLayout_tl_tab_paddingTop, dp2px(0));
        mTabPaddingBottom = ta.getDimension(R.styleable.SlidingTabLayout_tl_tab_paddingBottom, dp2px(0));
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
            ...
            if (tv_tab_title != null) {
                ...
                tv_tab_title.setPadding((int) mTabPadding, (int) mTabPaddingTop, (int) mTabPadding, (int) mTabPaddingBottom);
                if (mTextAllCaps) {
